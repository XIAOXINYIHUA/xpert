# Xpert AI（企业级 AI 数据分析平台）

> **Fork 说明**：本项目 Fork 自 xpert-ai/xpert，在原版 Agent-Workflow 混合架构基础上进行了定制化开发与集成实践。

## 项目简介

Xpert AI 是一个面向企业的开源 AI 分析和决策平台，采用创新的 Agent-Workflow 混合架构。本 Fork 主要用于企业级数据分析场景的深度应用与二次开发。
